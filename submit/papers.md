...
If your paper is accepted, you will receive an email from us on how to ready your paper for publishing. Word users should be prepared to submit to TAPS approximately one week earlier than the stated camera-ready deadline. The first author of each accepted paper must register for the in-person rate for the conference (regardless of whether or not they will be attending in person). Otherwise, we cannot guarantee the publication of your paper. Please ensure that you and your co-authors[ obtain an ORCID ID](https://orcid.org/register) to complete the publishing process for your accepted paper.
